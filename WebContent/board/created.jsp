...
<div id="bbs">
	...
	<form action="" method="post" name="myForm">
		<div id="bbsCreated">
			...
			<div id="bbsCreated_content">   
				<dl>
					<dt>내&nbsp;&nbsp;&nbsp;&nbsp;용</dt>
					<dd>
						<textarea rows="12" cols="63" name="content" class="boxTA">${dto.subject }</textarea>
					</dd>	
				</dl>
			</div>
		...
		<div id="bbsCreated_footer">
			<input type = "hidden" name = "mode" value = "${mode }"/> <!-- 게시글 작성 -->
			...
			<c:if test="${mode == 'update' }">
				...
				<input type="button" value=" 수정취소 " class="btn2" onclick="javascript:location.href = '<%=cp %>/sbbs/list.action';"/>
			</c:if>		
